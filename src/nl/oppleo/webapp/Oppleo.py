...
try:
    ...
    def config_dashboard_access_restriction(function):
        ...
        def decorated(*args, **kwargs):
            ...
            oppleoLogger.debug('config_dashboard_access_restriction decorator [1] (restrictDashboardAccess: {restrictDashboardAccess}, remote_addr: {remote_addr}, routerIPAddress: {routerIPAddress}, is_authenticated: {is_authenticated})'.format(
            ...
            # TODO REMOVE - EXTRA LOGGING
            oppleoLogger.debug('config_dashboard_access_restriction decorator [3] NOT allowed')
    ...
    def connect(*args, **kwargs):
        ...
        # TODO REMOVE - EXTRA LOGGING
        oppleoLogger.debug('socketio.connect [1] (sid: {sid}, wsClientCnt: {wsClientCnt})'.format(sid=request.sid, wsClientCnt=wsClientCnt))
        ...
        # TODO REMOVE - EXTRA LOGGING
        oppleoLogger.debug('socketio.connect [2] (sid: {sid}, wsClientCnt: {wsClientCnt})'.format(sid=request.sid, wsClientCnt=wsClientCnt))
        ...
        # TODO REMOVE - EXTRA LOGGING
        oppleoLogger.debug('socketio.connect [3] (sid: {sid}, wsClientCnt: {wsClientCnt})'.format(sid=request.sid, wsClientCnt=wsClientCnt))
        ...
        # TODO REMOVE - EXTRA LOGGING
        oppleoLogger.debug('socketio.connect [4] (sid: {sid}, wsClientCnt: {wsClientCnt})'.format(sid=request.sid, wsClientCnt=wsClientCnt))
    ...
    def disconnect():
        ...
        # TODO REMOVE - EXTRA LOGGING
        oppleoLogger.debug('socketio.disconnect [1] (sid: {sid}, wsClientCnt: {wsClientCnt})'.format(sid=request.sid, wsClientCnt=wsClientCnt))
        ...
        # TODO REMOVE - EXTRA LOGGING
        oppleoLogger.debug('socketio.disconnect [2] (sid: {sid}, wsClientCnt: {wsClientCnt})'.format(sid=request.sid, wsClientCnt=wsClientCnt))
        ...
        # TODO REMOVE - EXTRA LOGGING
        oppleoLogger.debug('socketio.disconnect [3] (sid: {sid}, wsClientCnt: {wsClientCnt})'.format(sid=request.sid, wsClientCnt=wsClientCnt))
